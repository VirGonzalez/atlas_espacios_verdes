...
arg_borders <- st_read("../../Datasets/IGN/Provincias/Provincias.shp") %>% 
  summarise()
...
Descargaremos en export de todos los datos que tiene OSM para la Argentina, via GEOFABRIK: https://download.geofabrik.de/south-america/argentina.html
